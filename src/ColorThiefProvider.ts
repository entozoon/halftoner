// https://github.com/mhartington/star-track-ionic/blob/8a0bfc53412e2b5c13a3a032576e05d410882c9e/src/providers/color-thief/color-thief.ts
export class ColorThiefProvider {
  constructor() {}
  // Adaptation of ColorThief : http://lokeshdhakar.com/projects/color-thief/
  getPalette(pixels: any, colorCount?: number, quality?: number) {
    ...
    avg(force) {
      if (!this._avg || force) {
        ...
        if (ntot) {
          ...
          console.log("ColorThief: empty box");
          this._avg = [
